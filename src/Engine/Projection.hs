...
create_image::ET.Has_call_stack=>Int->Event a->Engine b a c d e->Engine b a c d e
create_image leaf_id event engine=engine {leaf=int_map_update leaf_id (create_projection_image event engine) engine.leaf}

create_image_safe::ET.Has_call_stack=>Int->Event a->Engine b a c d e->Engine b a c d e
...
remove_image::ET.Has_call_stack=>Int->Engine a b c d e->Engine a b c d e
remove_image leaf_id engine=engine {leaf=int_map_update leaf_id remove_projection_image engine.leaf}

remove_image_safe::ET.Has_call_stack=>Int->Engine a b c d e->Engine a b c d e
remove_image_safe leaf_id engine=engine {leaf=DIM.adjust remove_projection_image_safe leaf_id engine.leaf}

do_widget_transform::ET.Has_call_stack=>DS.Seq Int->Event a->Engine b a c d e->Widget b a c d e->Widget b a c d e
...
create_projection_image::ET.Has_call_stack=>Event a->Engine b a c d e->Projection b a c d e->Projection b a c d e
...
create_projection_image_safe::ET.Has_call_stack=>Event a->Engine b a c d e->Projection b a c d e->Projection b a c d e
...
remove_projection_image::ET.Has_call_stack=>Projection a b c d e->Projection a b c d e
...
remove_projection_image_safe::ET.Has_call_stack=>Projection a b c d e->Projection a b c d e
remove_projection_image_safe projection=case projection of
    With {ancestry_id,object}->Without {ancestry_id=ancestry_id,object=object}
    _->projection

insert_projection_object::ET.Has_call_stack=>Widget a b c d e->Projection a b c d e->Projection a b c d e
...
update_projection_object::ET.Has_call_stack=>(Widget a b c d e->Widget a b c d e)->Projection a b c d e->Projection a b c d e
...
functor_update_projection_object::ET.Has_call_stack=>Functor f=>(Widget a b c d e->f (Widget a b c d e))->Projection a b c d e->f (Projection a b c d e)
...
lookup_projection::ET.Has_call_stack=>Projection_strategy->Projection a b c d e->Widget a b c d e
...
lookup_projection_object::ET.Has_call_stack=>Projection a b c d e->Widget a b c d e
lookup_projection_object projection=case projection of
    Without {object}->object
    With {object}->object

lookup_projection_image::ET.Has_call_stack=>Projection a b c d e->Widget a b c d e
lookup_projection_image projection=case projection of
    With {image}->image
    _->EF.empty_error

lookup_projection_image_safe::ET.Has_call_stack=>Projection a b c d e->Widget a b c d e
lookup_projection_image_safe projection=case projection of
    Without {object}->object
    With {image}->image

lookup_projection_widget::ET.Has_call_stack=>Projection_path->Engine a b c d e->Widget a b c d e
lookup_projection_widget projection_path engine=case projection_path of
    ...
    Image_path {leaf_id}->lookup_projection_image (int_map_lookup leaf_id engine.leaf)
    Image_safe_path {leaf_id}->lookup_projection_image_safe (int_map_lookup leaf_id engine.leaf)

update_lookup_projection_widget::ET.Has_call_stack=>Projection_path->(Widget a b c d e->Widget a b c d e)->Engine a b c d e->(Engine a b c d e,Widget a b c d e)
update_lookup_projection_widget projection_path update engine=case projection_path of
    ...
    Image_path {leaf_id}->(engine,lookup_projection_image (int_map_lookup leaf_id engine.leaf))
    Image_safe_path {leaf_id}->(engine,lookup_projection_image_safe (int_map_lookup leaf_id engine.leaf))

update_lookup_projection_widget_a::ET.Has_call_stack=>(Widget a b c d e->Widget a b c d e)->Projection a b c d e->(Projection a b c d e,Widget a b c d e)
...
functor_lookup_projection_widget::ET.Has_call_stack=>Functor f=>Projection_path->(Widget a b c d e->f (Widget a b c d e))->Engine a b c d e->f (Engine a b c d e)
