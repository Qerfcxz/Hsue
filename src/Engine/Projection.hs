...
create_image::ET.Has_call_stack=>Int->Event a->Engine a->Engine a
create_image leaf_id event engine=engine {leaf=int_map_update leaf_id (create_projection_image event engine) engine.leaf}

create_image_safe::ET.Has_call_stack=>Int->Event a->Engine a->Engine a
...
remove_image::ET.Has_call_stack=>Int->Engine a->Engine a
remove_image leaf_id engine=engine {leaf=int_map_update leaf_id remove_projection_image engine.leaf}

remove_image_safe::ET.Has_call_stack=>Int->Engine a->Engine a
...
create_projection_image::ET.Has_call_stack=>Event a->Engine a->Projection a->Projection a
...
create_projection_image_safe::ET.Has_call_stack=>Event a->Engine a->Projection a->Projection a
...
remove_projection_image::ET.Has_call_stack=>Projection a->Projection a
...
remove_projection_image_safe::ET.Has_call_stack=>Projection a->Projection a
...
lookup_projection_image::ET.Has_call_stack=>Projection a->Widget a
lookup_projection_image projection=case projection of
    With {image}->image
    _->EF.empty_error

lookup_projection_image_safe::ET.Has_call_stack=>Projection a->Widget a
