...
for_text_b::DIM.IntMap Font->DM.Map String Int->DSeq.Seq Sentence->Extended->Extended->Extended->Extended->FCT.CFloat->FCT.CFloat->(Int->DSeq.Seq Row->DSeq.Seq (DSeq.Seq Row)->FCT.CFloat)->Int->DSeq.Seq Character->DSeq.Seq Row->DSeq.Seq (DSeq.Seq Row)->(DSeq.Seq (DSeq.Seq Row),Int)
...
for_text_c::Int->DIM.IntMap Glyph->DSeq.Seq Phrase->Extended->Extended->Extended->Extended->FCT.CFloat->FCT.CFloat->FCT.CFloat->FCT.CFloat->(Int->DSeq.Seq Row->FCT.CFloat)->Int->DSeq.Seq Character->DSeq.Seq Row->(DSeq.Seq Row,DSeq.Seq Character,Int,FCT.CFloat,FCT.CFloat,Extended,Extended,Extended,Extended)
...
for_text_d::Int->DIM.IntMap Glyph->DT.Text->Extended->Extended->Extended->Extended->FCT.CFloat->FCT.CFloat->FCT.CFloat->FCT.CFloat->FCT.CFloat->FCT.CFloat->FCT.CFloat->FCT.CFloat->FCT.CFloat->(Int->DSeq.Seq Row->FCT.CFloat)->Int->DSeq.Seq Character->DSeq.Seq Row->(DSeq.Seq Row,DSeq.Seq Character,Int,FCT.CFloat,FCT.CFloat,Extended,Extended,Extended,Extended)
