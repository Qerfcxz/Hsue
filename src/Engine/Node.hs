...
remove_node::Int->Engine a b c d e->IO (Engine a b c d e)
...
remove_node_a::DIS.IntSet->DIS.IntSet->Engine a b c d e->IO (Engine a b c d e)
...
remove_node_leaf::Int->Engine a b c d e->IO (Engine a b c d e)
...
remove_node_node::Int->Engine a b c d e->IO (Engine a b c d e)
