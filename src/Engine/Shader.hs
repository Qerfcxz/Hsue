...
create_graphics_pipeline::FP.Ptr SDLT.SDL_Window->FP.Ptr SDLT.SDL_GPUDevice->FP.Ptr SDLT.SDL_GPUShader->FP.Ptr SDLT.SDL_GPUShader->Blend_state->IO (FP.Ptr SDLT.SDL_GPUGraphicsPipeline)
...
create_canvas_graphics_pipeline::FP.Ptr SDLT.SDL_GPUDevice->FP.Ptr SDLT.SDL_GPUShader->FP.Ptr SDLT.SDL_GPUShader->Blend_state->IO (FP.Ptr SDLT.SDL_GPUGraphicsPipeline)
...
{-# INLINE insert_pipeline_id #-}
{-# INLINE delete_pipeline_id #-}
