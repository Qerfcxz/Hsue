...
selector_update update this_selector this_widget=case this_selector of
    ...
    Hosted_selector {maybe_value,selector,bounded,strict}->case this_widget of
        ...
        Vector {index,size,vector_widget}->selector_update_a maybe_value update (vector_default_selector_update bounded this_widget id (\this_index this_this_selector this_vector_widget->CMST.runST (transform_vector_widget (\this_this_vector_widget->DVM.write this_this_vector_widget this_index (selector_update update this_this_selector (this_vector_widget DV.! this_index))) this_vector_widget)) selector index size vector_widget)
    ...
    Group_selector {maybe_value,group_selector,bounded,strict}->case this_widget of
        ...
        _->selector_update_b strict maybe_value update this_widget
    Vector_selector {maybe_value,vector_selector,bounded,strict}->case this_widget of
        Vector {index,size,vector_widget}->selector_update_a maybe_value update (Vector {index=index,size=size,vector_widget=CMST.runST (transform_vector_widget (\this_vector_widget->CM.void (DIM.traverseWithKey (\this_index single_selector->if bounded then DVM.write this_vector_widget this_index (selector_update update single_selector (vector_widget DV.! this_index)) else maybe (return ()) (DVM.write this_vector_widget this_index . selector_update update single_selector) (vector_widget DV.!? this_index)) vector_selector)) vector_widget)})
        _->selector_update_b strict maybe_value update this_widget
    Widget_trigger_selector {maybe_value,selector,strict}->case this_widget of
...
trigger_selector_update bounded update this_widget=case this_widget of
    ...
    Vector {index,size,vector_widget}->vector_default_selector_update bounded this_widget id (\this_index this_update this_vector_widget->CMST.runST (transform_vector_widget (\this_this_vector_widget->DVM.write this_this_vector_widget this_index (trigger_selector_update bounded this_update (this_vector_widget DV.! this_index))) this_vector_widget)) update index size vector_widget
...
default_selector_update bounded update this_widget=case this_widget of
    ...
    Vector {index,size,vector_widget}->vector_default_selector_update bounded this_widget id (\this_index this_update this_vector_widget->CMST.runST (transform_vector_widget (\this_this_vector_widget->DVM.write this_this_vector_widget this_index (default_selector_update bounded this_update (this_vector_widget DV.! this_index))) this_vector_widget)) update index size vector_widget
...
selector_monad_update update this_selector this_widget=case this_selector of
    ...
    Hosted_selector {maybe_value,selector,bounded,strict}->case this_widget of
        ...
        Vector {index,size,vector_widget}->selector_monad_update_a maybe_value update (vector_default_selector_update bounded (return this_widget) fmap (\this_index this_this_selector this_vector_widget->fmap (\widget->CMST.runST (transform_vector_widget (\this_this_vector_widget->DVM.write this_this_vector_widget this_index widget) this_vector_widget)) (selector_monad_update update this_this_selector (this_vector_widget DV.! this_index))) selector index size vector_widget)
    ...
    Group_selector {maybe_value,group_selector,bounded,strict}->case this_widget of
        ...
        _->selector_monad_update_b strict maybe_value update this_widget
    Vector_selector {maybe_value,vector_selector,bounded,strict}->case this_widget of
        Vector {index,size,vector_widget}->selector_monad_update_c maybe_value update (\this_vector_widget->Vector {index=index,size=size,vector_widget=CMST.runST (transform_vector_widget (\this_this_vector_widget->CM.void (DIM.traverseWithKey (maybe (return ()) . DVM.write this_this_vector_widget) this_vector_widget)) vector_widget)}) (DIM.traverseWithKey (\this_index single_selector->if bounded then fmap Just (selector_monad_update update single_selector (vector_widget DV.! this_index)) else maybe (return Nothing) (fmap Just . selector_monad_update update single_selector) (vector_widget DV.!? this_index)) vector_selector)
        _->selector_monad_update_b strict maybe_value update this_widget
    Widget_trigger_selector {maybe_value,selector,strict}->case this_widget of
...
trigger_selector_applicative_update bounded update this_widget=case this_widget of
    ...
    Vector {index,size,vector_widget}->vector_default_selector_update bounded (pure this_widget) fmap (\this_index this_update this_vector_widget->fmap (\widget->CMST.runST (transform_vector_widget (\this_this_vector_widget->DVM.write this_this_vector_widget this_index widget) this_vector_widget)) (trigger_selector_applicative_update bounded this_update (this_vector_widget DV.! this_index))) update index size vector_widget
...
default_selector_applicative_update bounded update this_widget=case this_widget of
    ...
    Vector {index,size,vector_widget}->vector_default_selector_update bounded (pure this_widget) fmap (\this_index this_update this_vector_widget->fmap (\widget->CMST.runST (transform_vector_widget (\this_this_vector_widget->DVM.write this_this_vector_widget this_index widget) this_vector_widget)) (default_selector_applicative_update bounded this_update (this_vector_widget DV.! this_index))) update index size vector_widget
