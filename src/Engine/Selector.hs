...
selector_monad_update update this_selector this_widget=case this_selector of
    ...
    Hosted_selector {maybe_value,selector,bounded,strict}->case this_widget of
        ...
        Vector {index,size,vector_widget}->selector_monad_update_a maybe_value update (vector_default_selector_update bounded (return this_widget) fmap (\this_index this_this_selector this_vector_widget->fmap (\single_widget->CMST.runST (update_vector_widget (\this_this_vector_widget->DVM.write this_this_vector_widget this_index single_widget) this_vector_widget)) (selector_monad_update update this_this_selector (this_vector_widget DV.! this_index))) selector index size vector_widget)
...
trigger_selector_applicative_update bounded update this_widget=case this_widget of
    ...
    Vector {index,size,vector_widget}->vector_default_selector_update bounded (pure this_widget) fmap (\this_index this_update this_vector_widget->fmap (\single_widget->CMST.runST (update_vector_widget (\this_this_vector_widget->DVM.write this_this_vector_widget this_index single_widget) this_vector_widget)) (trigger_selector_applicative_update bounded this_update (this_vector_widget DV.! this_index))) update index size vector_widget
...
default_selector_applicative_update bounded update this_widget=case this_widget of
    ...
    Vector {index,size,vector_widget}->vector_default_selector_update bounded (pure this_widget) fmap (\this_index this_update this_vector_widget->fmap (\single_widget->CMST.runST (update_vector_widget (\this_this_vector_widget->DVM.write this_this_vector_widget this_index single_widget) this_vector_widget)) (default_selector_applicative_update bounded this_update (this_vector_widget DV.! this_index))) update index size vector_widget
