...
clean_engine engine=do
    ...
    DF.traverse_ (\pipeline->SDLF.sdl_release_gpu_graphics_pipeline engine.device pipeline.sdl_pipeline) (DIM.elems engine.pipeline)
