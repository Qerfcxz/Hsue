...
run_coroutine::ET.Has_call_stack=>Int->Selector a->DS.Seq Int->Event b->Engine c b d e f->Engine c b d e f
...
run_coroutine_a::ET.Has_call_stack=>DS.Seq Int->Event a->Engine b a c d e->Widget b a c d e->(Widget b a c d e,DS.Seq (Engine b a c d e->Engine b a c d e))
run_coroutine_a this_index event engine widget=case widget of
    Coroutine {index,initial_min_index,min_index,initial_max_index,max_index,variable_size,user_variable_size,coroutine_state,layout,linear_coroutine,iterative}->let (update,new_coroutine_state)=DF.foldl' (\(this_update,this_coroutine_state) single_index->int_map_functor_update single_index (\this_this_coroutine_state->run_coroutine_b event engine iterative linear_coroutine layout this_this_coroutine_state this_update) this_coroutine_state) (DS.empty,coroutine_state) this_index in (Coroutine {index=index,initial_min_index=initial_min_index,min_index=min_index,initial_max_index=initial_max_index,max_index=max_index,variable_size=variable_size,user_variable_size=user_variable_size,coroutine_state=new_coroutine_state,layout=layout,linear_coroutine=linear_coroutine,iterative=iterative},update)
    _->EF.empty_error

run_coroutine_b::ET.Has_call_stack=>Event a->Engine b a c d e->Bool->DV.Vector (Linear_coroutine b a c d e)->DVS.Vector Layout->Coroutine_state b a c d e->DS.Seq (Engine b a c d e->Engine b a c d e)->(DS.Seq (Engine b a c d e->Engine b a c d e),Coroutine_state b a c d e)
...
for_iterative::ET.Has_call_stack=>Bool->(Engine a b c d e->Engine a b c d e)->Engine a b c d e->Engine a b c d e
for_iterative iterative update engine=if iterative then update engine else engine

init_coroutine_state::ET.Has_call_stack=>Int->Int->Widget a b c d e->Coroutine_state a b c d e
...
to_coroutine::ET.Has_call_stack=>DS.Seq (Coroutine a b c d e)->Coroutine a b c d e
...
lift_coroutine::ET.Has_call_stack=>Coroutine a b c d e->Raw_coroutine a b c d e ()
lift_coroutine coroutine=Raw_coroutine {iterator=lift_coroutine_a coroutine}

lift_coroutine_a::ET.Has_call_stack=>Coroutine a b c d e->Int->(Int,DS.Seq (Coroutine a b c d e),())
lift_coroutine_a coroutine int=(int,DS.singleton coroutine,())

do_empty::ET.Has_call_stack=>Raw_coroutine a b c d e ()
do_empty=Raw_coroutine {iterator=do_empty_a}

do_empty_a::ET.Has_call_stack=>Int->(Int,DS.Seq (Coroutine a b c d e),())
do_empty_a int=(int,DS.empty,())

do_declare::ET.Has_call_stack=>Raw_coroutine a b c d e Int
do_declare=Raw_coroutine {iterator=do_declare_a}

do_declare_a::ET.Has_call_stack=>Int->(Int,DS.Seq (Coroutine a b c d e),Int)
do_declare_a int=(int+1,DS.empty,int)

do_emit::ET.Has_call_stack=>(Event a->Engine b a c d e->Widget b a c d e->(Widget b a c d e,Engine b a c d e->Engine b a c d e))->Raw_coroutine b a c d e ()
do_emit emit=lift_coroutine (Emit {emit=emit})

do_wait::ET.Has_call_stack=>Dynamic_int a b c d e->Raw_coroutine a b c d e ()
do_wait dynamic_int=lift_coroutine (Wait {dynamic_int=dynamic_int})

do_forever::ET.Has_call_stack=>Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
do_then::ET.Has_call_stack=>Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
do_while::ET.Has_call_stack=>Dynamic_bool a b c d e->Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
do_pause::ET.Has_call_stack=>Dynamic_bool a b c d e->Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
do_skip::ET.Has_call_stack=>Dynamic_bool a b c d e->Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
do_assign::ET.Has_call_stack=>Dynamic_int a b c d e->Int->Raw_coroutine a b c d e ()
do_assign dynamic_int int=lift_coroutine (Assign {dynamic_int=dynamic_int,int=int})

do_repeat::ET.Has_call_stack=>Dynamic_int a b c d e->Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
do_clone::ET.Has_call_stack=>Int->Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
do_if::ET.Has_call_stack=>Dynamic_bool a b c d e->Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
do_dynamic_clone::ET.Has_call_stack=>Dynamic_int a b c d e->Int->Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
do_case::ET.Has_call_stack=>Dynamic_int a b c d e->Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
do_fork::ET.Has_call_stack=>Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
do_race::ET.Has_call_stack=>Dynamic_int a b c d e->Int->Raw_coroutine a b c d e ()->Raw_coroutine a b c d e ()
...
raw_coroutine_unary_generator::ET.Has_call_stack=>(Coroutine a b c d e->DS.Seq (Coroutine a b c d e)->DS.Seq (Coroutine a b c d e)->DS.Seq (Coroutine a b c d e))->(Int->(Int,DS.Seq (Coroutine a b c d e),()))->Int->(Int,DS.Seq (Coroutine a b c d e),())
...
raw_coroutine_unary_operator::ET.Has_call_stack=>(DS.Seq (Coroutine a b c d e)->DS.Seq (Coroutine a b c d e))->(Int->(Int,DS.Seq (Coroutine a b c d e),()))->Int->(Int,DS.Seq (Coroutine a b c d e),())
...
raw_coroutine_binary_operator::ET.Has_call_stack=>(DS.Seq (Coroutine a b c d e)->DS.Seq (Coroutine a b c d e)->DS.Seq (Coroutine a b c d e))->(Int->(Int,DS.Seq (Coroutine a b c d e),()))->(Int->(Int,DS.Seq (Coroutine a b c d e),()))->Int->(Int,DS.Seq (Coroutine a b c d e),())
...
from_coroutine::ET.Has_call_stack=>Coroutine a b c d e->Int->(DV.Vector (Linear_coroutine a b c d e),DVS.Vector Layout,Int,Int)
...
from_coroutine_a::ET.Has_call_stack=>Coroutine a b c d e->Int->Int->Int->Int->Int->DVSM.MVector f Layout->DIM.IntMap (Linear_coroutine a b c d e)->CMST.ST f (DIM.IntMap (Linear_coroutine a b c d e),DVSM.MVector f Layout,Int,Int,Int,DIM.IntMap Int)
from_coroutine_a this_coroutine layout_size clone_number code_index user_int_index int_index layout linear_coroutine=case this_coroutine of
    ...
    Dynamic_clone {dynamic_int,int,coroutine}->if int<=0 then EF.empty_error else do
        (new_linear_coroutine,new_layout,new_int_index,new_user_int_index,new_code_index,group_int_index)<-from_coroutine_a coroutine layout_size (int*clone_number) (code_index+1) user_int_index (int_index+clone_number) layout linear_coroutine
    ...
    Race {dynamic_int,first_int,second_int,coroutine_sequence}->let countdown_int_index=int_index+clone_number in do
        ...
        let kill_code_index=new_code_index+3 in let new_group_int_index=DIM.insert int_index second_int group_int_index in return (DIM.insert kill_code_index (Linear_kill {group_int_index=new_group_int_index}) (DIM.insert (new_code_index+2) (Linear_yield {code_index=new_code_index}) (DIM.insert (new_code_index+1) (Linear_wake_group {int_index=int_index,dynamic_int=dynamic_int}) (DIM.insert new_code_index (Linear_less_jump {int_index=countdown_int_index,code_index=kill_code_index,int=second_int-first_int+1}) (DIM.insert (code_index+1) (Linear_jump {code_index=new_code_index}) (DIM.insert code_index (Linear_create_group {first_int_index=int_index,second_int_index=countdown_int_index,group_code_index=group_code_index,int=second_int}) new_linear_coroutine))))),new_layout,new_int_index,new_user_int_index,new_code_index+4,new_group_int_index)

then_coroutine::ET.Has_call_stack=>DS.Seq (Coroutine a b c d e)->Int->Int->Int->Int->Int->DVSM.MVector f Layout->DIM.IntMap (Linear_coroutine a b c d e)->CMST.ST f (DIM.IntMap (Linear_coroutine a b c d e),DVSM.MVector f Layout,Int,Int,Int,DIM.IntMap Int)
...
case_coroutine::ET.Has_call_stack=>DIM.IntMap Int->DIS.IntSet->DS.Seq (Coroutine a b c d e)->Int->Int->Int->Int->Int->Int->Int->Int->DVSM.MVector f Layout->DIM.IntMap (Linear_coroutine a b c d e)->CMST.ST f (DIM.IntMap (Linear_coroutine a b c d e),DVSM.MVector f Layout,Int,Int,Int,Linear_coroutine a b c d e,DIM.IntMap Int)
...
case_coroutine_a::ET.Has_call_stack=>DIM.IntMap Int->Int->Int->Int->Int->DIM.IntMap (Linear_coroutine a b c d e)->(DIM.IntMap (Linear_coroutine a b c d e),Int)
...
fork_coroutine::ET.Has_call_stack=>DS.Seq (Coroutine a b c d e)->Int->Int->Int->Int->Int->Int->Int->DVSM.MVector f Layout->DIM.IntMap (Linear_coroutine a b c d e)->CMST.ST f (DIM.IntMap (Linear_coroutine a b c d e),DVSM.MVector f Layout,Int,Int,Int,DIM.IntMap Int,DIM.IntMap Int)
...
race_coroutine::ET.Has_call_stack=>DS.Seq (Coroutine a b c d e)->Int->Int->Int->Int->Int->Int->Int->DVSM.MVector f Layout->DIM.IntMap (Linear_coroutine a b c d e)->CMST.ST f (DIM.IntMap (Linear_coroutine a b c d e),DVSM.MVector f Layout,Int,Int,Int,DIM.IntMap Int,DIM.IntMap Int)
...
step_coroutine_a linear_coroutine main_index clone_index this_code_index program_counter_index index_group_index survived_main_index_group newborn_main_index_group main_index_group index_group program_counter layout user_variable variable updater update event engine widget=case linear_coroutine DV.! this_code_index of
    ...
    Linear_wake_group {int_index,dynamic_int}->do
        new_int<-DVUM.read variable (int_index+clone_index)
        let new_index_group_index=new_int+dynamic_int.dynamic_int (user_variable_getter user_variable layout clone_index) event engine widget in let (new_index_group,maybe_single_index_group)=int_map_delete_maybe_lookup new_index_group_index index_group in case maybe_single_index_group of
            Nothing->step_coroutine_a linear_coroutine main_index clone_index (this_code_index+1) program_counter_index index_group_index survived_main_index_group newborn_main_index_group main_index_group index_group program_counter layout user_variable variable updater update event engine widget
            Just single_index_group->do
