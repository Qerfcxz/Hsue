...
from_coroutine_a this_coroutine clone_number code_index user_int_index int_index layout linear_coroutine=case this_coroutine of
    ...
    Fork {int,coroutine,coroutine_sequence}->do
        ...
        (final_linear_coroutine,final_layout,final_int_index,final_user_int_index,fork_end_code_index,fork_group_int_index,group_code_index)<-fork_coroutine coroutine_sequence 0 countdown_int_index clone_number (jump_code_index+1) new_user_int_index new_int_index new_layout new_linear_coroutine
...
clone_coroutine group_int_index int clone_number=DIS.foldl' (\this_group_int_index int_index->clone_coroutine_a int 0 int_index clone_number this_group_int_index) DIS.empty group_int_index

clone_coroutine_a::Int->Int->Int->Int->DIS.IntSet->DIS.IntSet
clone_coroutine_a int index int_index clone_number this_group_int_index=if int<=index then this_group_int_index else clone_coroutine_a int (index+1) int_index clone_number (DIS.insert (int_index+index*clone_number) this_group_int_index)
