...
do_assign::ET.Has_call_stack=>Dynamic_int a->Int->Raw_coroutine a ()
...
do_dynamic_clone::ET.Has_call_stack=>Dynamic_int a->Int->Raw_coroutine a ()->Raw_coroutine a ()
...
do_race::ET.Has_call_stack=>Dynamic_int a->Int->Raw_coroutine a ()->Raw_coroutine a ()
