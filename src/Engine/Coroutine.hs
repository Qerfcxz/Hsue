...
from_coroutine_a this_coroutine layout_size clone_number code_index user_int_index int_index layout linear_coroutine=case this_coroutine of
    ...
    If {dynamic_bool,first_coroutine,second_coroutine}->do
        ...
        (second_linear_coroutine,second_layout,second_int_index,second_user_int_index,second_code_index,second_group_int_index)<-from_coroutine_a second_coroutine layout_size clone_number new_code_index first_user_int_index int_index first_layout first_linear_coroutine
...
case_coroutine case_code_index jump_code_index coroutine_sequence layout_size int index max_int_index clone_number code_index user_int_index int_index layout linear_coroutine=case coroutine_sequence of
    ...
    coroutine DS.:<| other_coroutine->do
        (new_linear_coroutine,new_layout,new_int_index,new_user_int_index,new_code_index,group_int_index)<-from_coroutine_a coroutine layout_size clone_number code_index user_int_index (int_index+clone_number) layout linear_coroutine
        (final_linear_coroutine,final_layout,final_int_index,final_user_int_index,final_code_index,single_linear_coroutine,final_group_int_index)<-case_coroutine (DIM.insert index code_index case_code_index) (DIS.insert new_code_index jump_code_index) other_coroutine layout_size int (index+1) (max new_int_index max_int_index) clone_number (new_code_index+1) (max user_int_index new_user_int_index) int_index new_layout new_linear_coroutine
