...
from_coroutine_a this_coroutine clone_number code_index user_int_index int_index layout linear_coroutine=case this_coroutine of
    ...
    Pause {dynamic_bool,coroutine}->let body_code_index=code_index+2 in let countdown_int_index=int_index+clone_number in do
        ...
        let loop_code_index=new_code_index+1 in let yield_code_index=loop_code_index+3 in let jump_code_index=loop_code_index+4 in let new_group_int_index=DIS.insert int_index group_int_index in return (DIM.insert jump_code_index (Linear_kill_group {group_int_index=new_group_int_index,int=1}) (DIM.insert yield_code_index (Linear_yield {code_index=loop_code_index}) (DIM.insert (loop_code_index+2) (Linear_wake {int_index=int_index}) (DIM.insert (loop_code_index+1) (Linear_true_jump {code_index=yield_code_index,dynamic_bool=dynamic_bool}) (DIM.insert loop_code_index (Linear_less_jump {int_index=countdown_int_index,code_index=jump_code_index,int=1}) (DIM.insert new_code_index (Linear_countdown {int_index=countdown_int_index}) (DIM.insert (code_index+1) (Linear_jump {code_index=loop_code_index}) (DIM.insert code_index (Linear_create_group {first_int_index=int_index,second_int_index=countdown_int_index,group_code_index=DIM.singleton 0 body_code_index,int=1}) new_linear_coroutine))))))),new_layout,new_int_index,new_user_int_index,loop_code_index+5,new_group_int_index)
    Skip {dynamic_bool,coroutine}->let body_code_index=code_index+2 in let countdown_int_index=int_index+clone_number in do
        (new_linear_coroutine,new_layout,new_int_index,new_user_int_index,new_code_index,group_int_index)<-from_coroutine_a coroutine clone_number body_code_index user_int_index (int_index+2*clone_number) layout linear_coroutine
        let loop_code_index=new_code_index+1 in let jump_code_index=loop_code_index+4 in let new_group_int_index=DIS.insert int_index group_int_index in return (DIM.insert jump_code_index (Linear_kill_group {group_int_index=new_group_int_index,int=1}) (DIM.insert (loop_code_index+3) (Linear_yield {code_index=loop_code_index}) (DIM.insert (loop_code_index+2) (Linear_wake {int_index=int_index}) (DIM.insert (loop_code_index+1) (Linear_true_jump {code_index=jump_code_index,dynamic_bool=dynamic_bool}) (DIM.insert loop_code_index (Linear_less_jump {int_index=countdown_int_index,code_index=jump_code_index,int=1}) (DIM.insert new_code_index (Linear_countdown {int_index=countdown_int_index}) (DIM.insert (code_index+1) (Linear_jump {code_index=loop_code_index}) (DIM.insert code_index (Linear_create_group {first_int_index=int_index,second_int_index=countdown_int_index,group_code_index=DIM.singleton 0 body_code_index,int=1}) new_linear_coroutine))))))),new_layout,new_int_index,new_user_int_index,loop_code_index+5,new_group_int_index)
    ...
    Race {dynamic_int,first_int,second_int,coroutine_sequence}->let countdown_int_index=int_index+clone_number in do
        (new_linear_coroutine,new_layout,new_int_index,new_user_int_index,new_code_index,group_int_index,group_code_index)<-race_coroutine coroutine_sequence 0 countdown_int_index clone_number (code_index+2) user_int_index (int_index+2*clone_number) layout linear_coroutine
        let kill_code_index=new_code_index+3 in let new_group_int_index=DIS.insert int_index group_int_index in return (DIM.insert kill_code_index (Linear_kill_group {group_int_index=new_group_int_index,int=second_int}) (DIM.insert (new_code_index+2) (Linear_yield {code_index=new_code_index}) (DIM.insert (new_code_index+1) (Linear_wake_group {int_index=int_index,dynamic_int=dynamic_int,int=second_int}) (DIM.insert new_code_index (Linear_less_jump {int_index=countdown_int_index,code_index=kill_code_index,int=second_int-first_int+1}) (DIM.insert (code_index+1) (Linear_jump {code_index=new_code_index}) (DIM.insert code_index (Linear_create_group {first_int_index=int_index,second_int_index=countdown_int_index,group_code_index=group_code_index,int=second_int}) new_linear_coroutine))))),new_layout,new_int_index,new_user_int_index,new_code_index+4,new_group_int_index)
...
clone_coroutine_a int index single_int_index clone_number this_group_int_index=if int<=index then this_group_int_index else clone_coroutine_a int (index+1) single_int_index clone_number (DIS.insert (single_int_index+index*clone_number) this_group_int_index)
...
fork_coroutine::DS.Seq (Coroutine a b c d e)->Int->Int->Int->Int->Int->Int->DVSM.MVector f Layout->DIM.IntMap (Linear_coroutine a b c d e)->CMST.ST f (DIM.IntMap (Linear_coroutine a b c d e),DVSM.MVector f Layout,Int,Int,Int,DIS.IntSet,DIM.IntMap Int)
fork_coroutine coroutine_sequence index countdown_int_index clone_number code_index user_int_index int_index layout linear_coroutine=case coroutine_sequence of
    DS.Empty->return (linear_coroutine,layout,int_index,user_int_index,code_index,DIS.empty,DIM.empty)
    coroutine DS.:<| other_coroutine->do
        (new_linear_coroutine,new_layout,new_int_index,new_user_int_index,new_code_index,group_int_index)<-from_coroutine_a coroutine clone_number code_index user_int_index int_index layout linear_coroutine
        (final_linear_coroutine,final_layout,final_int_index,final_user_int_index,final_code_index,final_group_int_index,group_code_index)<-fork_coroutine other_coroutine (index+1) countdown_int_index clone_number (new_code_index+1) new_user_int_index (max int_index new_int_index) new_layout (DIM.insert new_code_index (Linear_countdown {int_index=countdown_int_index}) new_linear_coroutine)
        return (final_linear_coroutine,final_layout,final_int_index,final_user_int_index,final_code_index,DIS.union group_int_index final_group_int_index,DIM.insert index code_index group_code_index)

race_coroutine::DS.Seq (Coroutine a b c d e)->Int->Int->Int->Int->Int->Int->DVSM.MVector f Layout->DIM.IntMap (Linear_coroutine a b c d e)->CMST.ST f (DIM.IntMap (Linear_coroutine a b c d e),DVSM.MVector f Layout,Int,Int,Int,DIS.IntSet,DIM.IntMap Int)
race_coroutine coroutine_sequence index countdown_int_index clone_number code_index user_int_index int_index layout linear_coroutine=case coroutine_sequence of
    ...
    coroutine DS.:<| other_coroutine->do
        (new_linear_coroutine,new_layout,new_int_index,new_user_int_index,new_code_index,group_int_index)<-from_coroutine_a coroutine clone_number code_index user_int_index int_index layout linear_coroutine
        (final_linear_coroutine,final_layout,final_int_index,final_user_int_index,final_code_index,final_group_int_index,group_code_index)<-race_coroutine other_coroutine (index+1) countdown_int_index clone_number (new_code_index+1) new_user_int_index (max int_index new_int_index) new_layout (DIM.insert new_code_index (Linear_countdown {int_index=countdown_int_index}) new_linear_coroutine)
        return (final_linear_coroutine,final_layout,final_int_index,final_user_int_index,final_code_index,DIS.union group_int_index final_group_int_index,DIM.insert index code_index group_code_index)
