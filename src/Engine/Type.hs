...
data Action=Close|Resize {width::FCT.CFloat,height::FCT.CFloat}|Press {press::Press,change::Key,maintain::DSet.Set Key}|Click {press::Press,mouse_button::Mouse_button,x::FCT.CFloat,y::FCT.CFloat}
