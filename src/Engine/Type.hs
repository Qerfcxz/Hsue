...
data Selector a=None_selector|Combine_selector {combine_selector::DSeq.Seq (Selector a)}|Self_selector {value::a}|All_selector {maybe_value::Maybe a,value::a}|Trigger_selector {maybe_value::Maybe a,value::a,bounded::Bool}|Default_selector {maybe_value::Maybe a,value::a,bounded::Bool}|Hosted_selector {maybe_value::Maybe a,selector::Selector a,bounded::Bool,strict::Bool}|Any_selector {maybe_value::Maybe a,selector::Selector a,strict::Bool}|Group_selector {maybe_value::Maybe a,group_selector::DIM.IntMap (Selector a),bounded::Bool,strict::Bool}|Vector_selector {maybe_value::Maybe a,vector_selector::DIM.IntMap (Selector a),bounded::Bool,strict::Bool}|Widget_trigger_selector {maybe_value::Maybe a,selector::Selector a,strict::Bool}|Widget_io_trigger_selector {maybe_value::Maybe a,selector::Selector a,strict::Bool}|Widget_mix_trigger_selector {maybe_value::Maybe a,selector::Selector a,strict::Bool}|Coroutine_selector {maybe_value::Maybe a,coroutine_selector::DIM.IntMap (Selector a),bounded::Bool,strict::Bool}
...
data Pipeline=Pipeline {sdl_pipeline::FP.Ptr SDLT.SDL_GPUGraphicsPipeline,vertex_shader_id::Int,fragment_shader_id::Int}

data Program_counter=Program_counter {code_index::Int,clone_index::Int}

data Canvas=Free_canvas {width::DW.Word32,height::DW.Word32,half_width::FCT.CFloat,half_height::FCT.CFloat,texture::FP.Ptr SDLT.SDL_GPUTexture,temporary_texture::FP.Ptr SDLT.SDL_GPUTexture}|Bound_canvas {texture::FP.Ptr SDLT.SDL_GPUTexture,temporary_texture::FP.Ptr SDLT.SDL_GPUTexture,leaf_id::Int}
...
data Visual=Triangle {first_point::Point,second_point::Point,third_point::Point}|Convex_polygon {point::DSeq.Seq Point}|Regular_polygon {number::Int,radius::FCT.CFloat,angle::FCT.CFloat}|Picture {half_width::FCT.CFloat,half_height::FCT.CFloat,min_u::FCT.CFloat,min_v::FCT.CFloat,max_u::FCT.CFloat,max_v::FCT.CFloat,path::String,locked::Bool}|Large_picture {half_width::FCT.CFloat,half_height::FCT.CFloat,album_id::Int}|Atlas {clip_request::DSeq.Seq Clip_request,path::String,clip::DVS.Vector Clip,index::Int,locked::Bool}|Large_atlas {clip::DVS.Vector Clip,album_id::Int,index::Int}|Animation {delay::DVS.Vector FCT.CFloat,moment::FCT.CFloat,half_width::FCT.CFloat,half_height::FCT.CFloat,reciprocal_width::FCT.CFloat,reciprocal_height::FCT.CFloat,padding::FCT.CFloat,width_number::Int,height_number::Int,album_number::Int,album_id::Int,count::Int,index::Int}|Canvas {width::DW.Word32,height::DW.Word32,half_width::FCT.CFloat,half_height::FCT.CFloat,canvas_id::Int,locked::Bool}

data Visual_request=Triangle_request {first_point::Point,second_point::Point,third_point::Point}|Convex_polygon_request {point::DSeq.Seq Point}|Regular_polygon_request {number::Int,radius::FCT.CFloat,angle::FCT.CFloat}|Picture_request {path::String}|Large_picture_request {path::String}|Atlas_request {clip_request::DSeq.Seq Clip_request,path::String}|Large_atlas_request {clip_request::DSeq.Seq Clip_request,path::String}|Animation_request {min_delay::FCT.CFloat,width::DW.Word32,height::DW.Word32,padding::Int,path::String}|Canvas_request {width::DW.Word32,height::DW.Word32,maybe_canvas_id::Maybe Int}
