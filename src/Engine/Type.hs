...
data Canvas=Free_canvas {canvas_width::DW.Word32,canvas_height::DW.Word32,texture::FP.Ptr SDLT.SDL_GPUTexture}|Bound_canvas {texture::FP.Ptr SDLT.SDL_GPUTexture,leaf_id::Int}
