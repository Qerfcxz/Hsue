...
data Visual_selector a=None_visual_selector|Combine_visual_selector {combine_visual_selector::DS.Seq (Visual_selector a)}|Any_visual_selector {value::a,strict::Bool}|Visual_trigger_selector {value::a,strict::Bool}|Visual_io_trigger_selector {value::a,strict::Bool}|Visual_mix_trigger_selector {value::a,strict::Bool}|Group_visual_selector {group_value::DIM.IntMap a,bounded::Bool,strict::Bool}|Vector_visual_selector {vector_value::DIM.IntMap a,bounded::Bool,strict::Bool}
