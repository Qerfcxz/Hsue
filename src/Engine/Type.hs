...
data Coroutine a=Done|Emit {emit::Engine a->Widget a->(Widget a,Engine a)}|Wait {dynamic_int::Dynamic_int a}|Forever {coroutine::Coroutine a}|While {dynamic_bool::Dynamic_bool a,coroutine::Coroutine a}|Repeat {dynamic_int::Dynamic_int a,coroutine::Coroutine a}|Then {first_coroutine::Coroutine a,second_coroutine::Coroutine a}|Fork {first_coroutine::Coroutine a,second_coroutine::Coroutine a}|If {dynamic_bool::Dynamic_bool a,first_coroutine::Coroutine a,second_coroutine::Coroutine a}

data Linear_coroutine a=Linear_end|Linear_emit {emit::Engine a->Widget a->(Widget a,Engine a)}|Linear_wait {int_index::Int}|Linear_deregister {first_int_index::Int,second_int_index::Int}|Linear_jump {code_index::Int}|Linear_fork {code_index::Int,coroutine_index::Int}|Linear_dynamic_int {int_index::Int,dynamic_int::Dynamic_int a}|Linear_int {int_index::Int,int::Int}|Linear_one_less_jump {code_index::Int,int_index::Int}|Linear_one_more_jump {code_index::Int,int_index::Int}|Linear_false_jump {code_index::Int,dynamic_bool::Dynamic_bool a}|Linear_register {first_int_index::Int,second_int_index::Int,int::Int}
