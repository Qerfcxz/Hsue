...
from_same_insert_widget_a insert_widget_strategy widget this_widget=case this_widget of
    ...
    Coroutine {initial_min_index,min_index,initial_max_index,max_index,variable_length,index,coroutine_state,linear_coroutine,iterative}->let (new_coroutine_state,new_max_index,new_min_index)=from_same_insert_widget_b min_index max_index insert_widget_strategy (init_coroutine_state variable_length widget) coroutine_state in Coroutine {initial_min_index=initial_min_index,min_index=new_min_index,initial_max_index=initial_max_index,max_index=new_max_index,variable_length=variable_length,index=index,coroutine_state=new_coroutine_state,linear_coroutine=linear_coroutine,iterative=iterative}
...
from_insert_widget::Int->DS.Seq (Insert a (Widget a))->Engine a->Engine a
...
from_insert_widget_a insert_widget widget=case widget of
    ...
    Coroutine {initial_min_index,min_index,initial_max_index,max_index,variable_length,index,coroutine_state,linear_coroutine,iterative}->let (new_coroutine_state,new_max_index,new_min_index)=from_insert_widget_b min_index max_index (init_coroutine_state variable_length) insert_widget coroutine_state in Coroutine {initial_min_index=initial_min_index,min_index=new_min_index,initial_max_index=initial_max_index,max_index=new_max_index,variable_length=variable_length,index=index,coroutine_state=new_coroutine_state,linear_coroutine=linear_coroutine,iterative=iterative}
...
create_widget this_widget_request engine=case this_widget_request of
    ...
    Coroutine_request {initial_min_index,initial_max_index,index,insert_widget_request,raw_coroutine,iterative}->let (linear_coroutine,variable_length)=from_coroutine (to_coroutine raw_coroutine) in do
        (coroutine_state,max_index,min_index,new_engine)<-from_insert_widget_request engine initial_min_index initial_max_index (init_coroutine_state variable_length) insert_widget_request DIM.empty
        return (new_engine,Coroutine {initial_min_index=initial_min_index,min_index=min_index,initial_max_index=initial_max_index,max_index=max_index,variable_length=variable_length,index=index,coroutine_state=coroutine_state,linear_coroutine=linear_coroutine,iterative=iterative})
...
from_insert_widget_request::Engine a->Int->Int->(Widget a->b)->DS.Seq (Insert a (Widget_request a))->DIM.IntMap b->IO (DIM.IntMap b,Int,Int,Engine a)
