...
to_collect_visual maybe_arrange u v maybe_border visual=case visual of
    ...
    Atlas {arrange,clip,index,locked}->if locked then EE.quick_error "to_collect_visual" 3 else case maybe arrange (`combine_arrange` arrange) maybe_arrange of
        Arrange {point,matrix,red,green,blue,alpha}->case move_clip point (clip DVS.! index) of
