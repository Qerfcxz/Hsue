...
for_unlock this_widget engine=case this_widget of
    ...
    Coroutine {initial_min_index,min_index,initial_max_index,max_index,index,coroutine_state,linear_coroutine,iterative}->do
        ...
        return (new_engine,Coroutine {initial_min_index=initial_min_index,min_index=min_index,initial_max_index=initial_max_index,max_index=max_index,index=index,coroutine_state=new_coroutine_state,linear_coroutine=linear_coroutine,iterative=iterative})
    Visual {origin,matrix,maybe_clip,red,green,blue,alpha,visual}->case visual of
