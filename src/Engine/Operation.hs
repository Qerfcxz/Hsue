...
get_store_widget::ET.Has_call_stack=>Convert Data f=>Widget a b c d e->f
get_store_widget widget=case widget of
    Store {store}->convert store
    _->EF.empty_error

update_store_widget::ET.Has_call_stack=>Convert Data a=>Convert a Data=>(a->a)->Widget b c d e f->Widget b c d e f
update_store_widget update widget=case widget of
    Store {store}->Store {store=convert (update (convert store))}
    _->EF.empty_error

update_vector_widget::ET.Has_call_stack=>Int->(Widget a b c d e->Widget a b c d e)->Widget a b c d e->Widget a b c d e
...
default_update_vector_widget::ET.Has_call_stack=>(Widget a b c d e->Widget a b c d e)->Widget a b c d e->Widget a b c d e
...
action_vector_widget::ET.Has_call_stack=>DVM.PrimMonad a=>(DVM.MVector (DVM.PrimState a) (Widget b c d e f)->a ())->DV.Vector (Widget b c d e f)->a (DV.Vector (Widget b c d e f))
...
update_group_widget::ET.Has_call_stack=>Int->(Widget a b c d e->Widget a b c d e)->Widget a b c d e->Widget a b c d e
...
default_update_group_widget::ET.Has_call_stack=>(Widget a b c d e->Widget a b c d e)->Widget a b c d e->Widget a b c d e
...
widget_lookup::ET.Has_call_stack=>Widget a b c d e->Widget a b c d e
...
lock_widget::ET.Has_call_stack=>Custom_widget d=>Widget a b c d e->Widget a b c d e
...
lock_visual::ET.Has_call_stack=>Visual->Visual
