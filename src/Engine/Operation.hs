...
default_update_vector_widget::ET.Has_call_stack=>(Widget a->Widget a)->Widget a->Widget a
...
action_vector_widget::ET.Has_call_stack=>DVM.PrimMonad a=>(DVM.MVector (DVM.PrimState a) (Widget b)->a ())->DV.Vector (Widget b)->a (DV.Vector (Widget b))
...
default_update_group_widget::ET.Has_call_stack=>(Widget a->Widget a)->Widget a->Widget a
...
lock_widget::ET.Has_call_stack=>Custom a=>Widget a->Widget a
