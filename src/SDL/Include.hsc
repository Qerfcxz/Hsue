...
{-# INLINE sdl_f_color_peek #-}
{-# INLINE sdl_f_color_poke #-}
{-# INLINE sdl_gpu_buffer_binding_size_of #-}
{-# INLINE sdl_gpu_buffer_binding_alignment #-}
{-# INLINE sdl_gpu_buffer_binding_peek #-}
{-# INLINE sdl_gpu_buffer_binding_poke #-}
{-# INLINE sdl_gpu_color_target_info_size_of #-}
{-# INLINE sdl_gpu_color_target_info_alignment #-}
{-# INLINE sdl_gpu_color_target_info_peek #-}
{-# INLINE sdl_gpu_color_target_info_poke #-}
{-# INLINE sdl_gpu_vertex_attribute_size_of #-}
{-# INLINE sdl_gpu_vertex_attribute_alignment #-}
{-# INLINE sdl_gpu_vertex_attribute_peek #-}
{-# INLINE sdl_gpu_vertex_attribute_poke #-}
{-# INLINE sdl_gpu_color_target_description_size_of #-}
{-# INLINE sdl_gpu_color_target_description_alignment #-}
{-# INLINE sdl_gpu_color_target_description_peek #-}
{-# INLINE sdl_gpu_color_target_description_poke #-}
{-# INLINE sdl_gpu_color_target_blend_state_size_of #-}
{-# INLINE sdl_gpu_color_target_blend_state_alignment #-}
{-# INLINE sdl_gpu_color_target_blend_state_peek #-}
{-# INLINE sdl_gpu_color_target_blend_state_poke #-}
{-# INLINE sdl_gpu_shader_create_info_size_of #-}
{-# INLINE sdl_gpu_shader_create_info_alignment #-}
{-# INLINE sdl_gpu_shader_create_info_peek #-}
{-# INLINE sdl_gpu_shader_create_info_poke #-}
{-# INLINE sdl_gpu_vertex_input_state_size_of #-}
{-# INLINE sdl_gpu_vertex_input_state_alignment #-}
{-# INLINE sdl_gpu_vertex_input_state_peek #-}
{-# INLINE sdl_gpu_vertex_input_state_poke #-}
{-# INLINE sdl_gpu_buffer_create_info_size_of #-}
{-# INLINE sdl_gpu_buffer_create_info_alignment #-}
{-# INLINE sdl_gpu_buffer_create_info_peek #-}
{-# INLINE sdl_gpu_buffer_create_info_poke #-}
{-# INLINE sdl_gpu_transfer_buffer_create_info_size_of #-}
{-# INLINE sdl_gpu_transfer_buffer_create_info_alignment #-}
{-# INLINE sdl_gpu_transfer_buffer_create_info_peek #-}
{-# INLINE sdl_gpu_transfer_buffer_create_info_poke #-}
{-# INLINE sdl_gpu_transfer_buffer_location_size_of #-}
{-# INLINE sdl_gpu_transfer_buffer_location_alignment #-}
{-# INLINE sdl_gpu_transfer_buffer_location_peek #-}
{-# INLINE sdl_gpu_transfer_buffer_location_poke #-}
{-# INLINE sdl_gpu_buffer_region_size_of #-}
{-# INLINE sdl_gpu_buffer_region_alignment #-}
{-# INLINE sdl_gpu_buffer_region_peek #-}
{-# INLINE sdl_gpu_buffer_region_poke #-}
{-# INLINE sdl_gpu_vertex_buffer_description_size_of #-}
{-# INLINE sdl_gpu_vertex_buffer_description_alignment #-}
{-# INLINE sdl_gpu_vertex_buffer_description_peek #-}
{-# INLINE sdl_gpu_vertex_buffer_description_poke #-}
{-# INLINE sdl_gpu_graphics_pipeline_target_info_size_of #-}
{-# INLINE sdl_gpu_graphics_pipeline_target_info_alignment #-}
{-# INLINE sdl_gpu_graphics_pipeline_target_info_peek #-}
{-# INLINE sdl_gpu_graphics_pipeline_target_info_poke #-}
{-# INLINE sdl_gpu_graphics_pipeline_create_info_size_of #-}
{-# INLINE sdl_gpu_graphics_pipeline_create_info_alignment #-}
{-# INLINE sdl_gpu_graphics_pipeline_create_info_peek #-}
{-# INLINE sdl_gpu_graphics_pipeline_create_info_poke #-}
{-# INLINE sdl_gpu_texture_create_info_size_of #-}
{-# INLINE sdl_gpu_texture_create_info_alignment #-}
{-# INLINE sdl_gpu_texture_create_info_peek #-}
{-# INLINE sdl_gpu_texture_create_info_poke #-}
{-# INLINE sdl_gpu_sampler_create_info_size_of #-}
{-# INLINE sdl_gpu_sampler_create_info_alignment #-}
{-# INLINE sdl_gpu_sampler_create_info_peek #-}
{-# INLINE sdl_gpu_sampler_create_info_poke #-}
{-# INLINE sdl_gpu_texture_sampler_binding_size_of #-}
{-# INLINE sdl_gpu_texture_sampler_binding_alignment #-}
{-# INLINE sdl_gpu_texture_sampler_binding_peek #-}
{-# INLINE sdl_gpu_texture_sampler_binding_poke #-}
{-# INLINE sdl_gpu_texture_transfer_info_size_of #-}
{-# INLINE sdl_gpu_texture_transfer_info_alignment #-}
{-# INLINE sdl_gpu_texture_transfer_info_peek #-}
{-# INLINE sdl_gpu_texture_transfer_info_poke #-}
{-# INLINE sdl_gpu_texture_region_size_of #-}
{-# INLINE sdl_gpu_texture_region_alignment #-}
{-# INLINE sdl_gpu_texture_region_peek #-}
{-# INLINE sdl_gpu_texture_region_poke #-}
{-# INLINE sdl_gpu_texture_location_size_of #-}
{-# INLINE sdl_gpu_texture_location_alignment #-}
{-# INLINE sdl_gpu_texture_location_peek #-}
{-# INLINE sdl_gpu_texture_location_poke #-}
{-# INLINE img_animation_size_of #-}
{-# INLINE img_animation_alignment #-}
{-# INLINE img_animation_peek #-}
{-# INLINE img_animation_poke #-}
{-# INLINE sdl_init_video #-}
{-# INLINE sdl_gpu_swapchaincomposition_sdr #-}
{-# INLINE sdl_gpu_presentmode_mailbox #-}
{-# INLINE sdl_gpu_shaderformat_dxil #-}
{-# INLINE sdl_gpu_loadop_clear #-}
{-# INLINE sdl_gpu_storeop_store #-}
{-# INLINE sdl_gpu_transferbufferusage_upload #-}
{-# INLINE sdl_gpu_vertexinputrate_vertex #-}
{-# INLINE sdl_gpu_primitivetype_trianglelist #-}
{-# INLINE sdl_gpu_shaderstage_vertex #-}
{-# INLINE sdl_gpu_shaderstage_fragment #-}
...
{-# INLINE sdl_gpu_blendfactor_invalid #-}
{-# INLINE sdl_gpu_blendfactor_zero #-}
{-# INLINE sdl_gpu_blendfactor_one #-}
{-# INLINE sdl_gpu_blendfactor_constant_color #-}
{-# INLINE sdl_gpu_blendfactor_dst_color #-}
{-# INLINE sdl_gpu_blendfactor_src_color #-}
{-# INLINE sdl_gpu_blendfactor_dst_alpha #-}
{-# INLINE sdl_gpu_blendfactor_src_alpha #-}
{-# INLINE sdl_gpu_blendfactor_src_alpha_saturate #-}
{-# INLINE sdl_gpu_blendfactor_one_minus_constant_color #-}
{-# INLINE sdl_gpu_blendfactor_one_minus_dst_color #-}
{-# INLINE sdl_gpu_blendfactor_one_minus_src_color #-}
{-# INLINE sdl_gpu_blendfactor_one_minus_dst_alpha #-}
{-# INLINE sdl_gpu_blendfactor_one_minus_src_alpha #-}
{-# INLINE sdl_gpu_blendop_invalid #-}
{-# INLINE sdl_gpu_blendop_min #-}
{-# INLINE sdl_gpu_blendop_max #-}
{-# INLINE sdl_gpu_blendop_add #-}
{-# INLINE sdl_gpu_blendop_subtract #-}
{-# INLINE sdl_gpu_blendop_reverse_subtract #-}
{-# INLINE sdl_gpu_colorcomponent_r #-}
{-# INLINE sdl_gpu_colorcomponent_g #-}
{-# INLINE sdl_gpu_colorcomponent_b #-}
{-# INLINE sdl_gpu_colorcomponent_a #-}
{-# INLINE sdl_gpu_indexelementsize_32bit #-}
{-# INLINE sdl_gpu_textureformat_r8g8b8a8_unorm #-}
{-# INLINE sdl_gpu_texturetype_2d #-}
{-# INLINE sdl_gpu_textureusage_color_target #-}
{-# INLINE sdl_gpu_textureusage_sampler #-}
{-# INLINE sdl_gpu_samplecount_1 #-}
{-# INLINE sdl_gpu_filter_nearest #-}
{-# INLINE sdl_gpu_filter_linear #-}
{-# INLINE sdl_gpu_samplermipmapmode_nearest #-}
{-# INLINE sdl_gpu_samplermipmapmode_linear #-}
{-# INLINE sdl_gpu_sampleraddressmode_repeat #-}
{-# INLINE sdl_gpu_sampleraddressmode_mirrored_repeat #-}
{-# INLINE sdl_gpu_sampleraddressmode_clamp_to_edge #-}
{-# INLINE sdl_window_fullscreen #-}
{-# INLINE sdl_window_hidden #-}
{-# INLINE sdl_window_borderless #-}
{-# INLINE sdl_window_resizable #-}
{-# INLINE sdl_window_always_on_top #-}
{-# INLINE sdl_system_cursor_default #-}
{-# INLINE sdl_system_cursor_pointer #-}
{-# INLINE sdl_pixelformat_rgba32 #-}
{-# INLINE sdl_event_size #-}
{-# INLINE sdl_event_alignment #-}
{-# INLINE sdl_user_event_data1_poke #-}
{-# INLINE sdl_user_event_data1_peek #-}
{-# INLINE sdl_event_type_peek #-}
{-# INLINE sdl_windowevent_windowid_peek #-}
{-# INLINE sdl_windowevent_data1_peek #-}
{-# INLINE sdl_windowevent_data2_peek #-}
{-# INLINE sdl_mousebuttonevent_windowid_peek #-}
{-# INLINE sdl_mousebuttonevent_button_peek #-}
{-# INLINE sdl_mousebuttonevent_x_peek #-}
{-# INLINE sdl_mousebuttonevent_y_peek #-}
{-# INLINE sdl_mousemotionevent_windowid_peek #-}
{-# INLINE sdl_mousemotionevent_x_peek #-}
{-# INLINE sdl_mousemotionevent_y_peek #-}
{-# INLINE sdl_mousemotionevent_xrel_peek #-}
{-# INLINE sdl_mousemotionevent_yrel_peek #-}
{-# INLINE sdl_mousewheelevent_windowid_peek #-}
{-# INLINE sdl_mousewheelevent_x_peek #-}
{-# INLINE sdl_mousewheelevent_y_peek #-}
{-# INLINE sdl_mousewheelevent_mouse_x_peek #-}
{-# INLINE sdl_mousewheelevent_mouse_y_peek #-}
{-# INLINE sdl_keyboardevent_windowid_peek #-}
{-# INLINE sdl_keyboardevent_key_peek #-}
{-# INLINE sdl_surface_w_peek #-}
{-# INLINE sdl_surface_h_peek #-}
{-# INLINE sdl_surface_pitch_peek #-}
{-# INLINE sdl_surface_pixels_peek #-}