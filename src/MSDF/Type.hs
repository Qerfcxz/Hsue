...
msdf_glyph_size_of::Has_call_stack=>MSDF_Glyph->Int
msdf_glyph_size_of _=40

msdf_glyph_alignment::Has_call_stack=>MSDF_Glyph->Int
...
msdf_output_size_of::Has_call_stack=>MSDF_Output->Int
msdf_output_size_of _=40

msdf_output_alignment::Has_call_stack=>MSDF_Output->Int
